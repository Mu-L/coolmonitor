...
export function AboutSettings() {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium dark:text-foreground text-light-text-primary mb-4">{t('about.title')}</h3>
      ...
      <div className="flex flex-col items-center justify-center text-center p-6">
        ...
        <h3 className="text-xl font-bold text-primary mb-2">{t('common.appName')}</h3>
        <p className="text-sm dark:text-foreground/80 text-light-text-secondary mb-4">{t('about.subtitle')}</p>
